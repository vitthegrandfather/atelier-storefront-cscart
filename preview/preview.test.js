...
test('product statuses use explicit high-contrast badge styles',()=>{assert.match(js,/product-badge--/);assert.match(css,/product__image \.product-badge/);assert.match(css,/text-transform:uppercase/)});
